...
switch str{val}
    case 'B.x'
        handles.s.B_choice='Bx';
    case 'B.y'
        handles.s.B_choice='By';
    case 'B.z'
        handles.s.B_choice='Bz';
    case 'B'
        handles.s.B_choice='abs';
end
...
switch Str{val}
    case 'x.y'
        handles.s.dim1_str='x';
        handles.s.dim2_str='y';
    case 'x.z'
        handles.s.dim1_str='x';
        handles.s.dim2_str='z';
    case 'y.z'
        handles.s.dim1_str='y';
        handles.s.dim2_str='z';
end
guidata(hObject,handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.s.dim3_min=str2double(get(hObject, 'String'))-0.5;
handles.s.dim3_max=str2double(get(hObject, 'String'))+0.5;
guidata(hObject,handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.s.sort=str2double(get(hObject,'String'))/100;
guidata(hObject,handles);
